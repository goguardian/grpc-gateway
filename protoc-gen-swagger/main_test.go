...
func TestParseReqParam(t *testing.T) {
	...
	clearFlags()
	pkgMap = make(map[string]string)
	expected = map[string]string{"google/api/annotations.proto": "github.com/goguardian/grpc-gateway/third_party/googleapis/google/api"}
	err = parseReqParam("allow_delete_body,file=./foo.pb,import_prefix=/bar/baz,Mgoogle/api/annotations.proto=github.com/goguardian/grpc-gateway/third_party/googleapis/google/api", f, pkgMap)
	if err != nil {
	...
	pkgMap = make(map[string]string)
	expected = map[string]string{"google/api/annotations.proto": "github.com/goguardian/grpc-gateway/third_party/googleapis/google/api"}
	err = parseReqParam("allow_delete_body=true,file=./foo.pb,import_prefix=/bar/baz,Mgoogle/api/annotations.proto=github.com/goguardian/grpc-gateway/third_party/googleapis/google/api", f, pkgMap)
	if err != nil {
