...
gulp.task('server', shell.task([
  'go build -o bin/example-server github.com/goguardian/grpc-gateway/examples/server/cmd/example-server',
]));

gulp.task('gateway', shell.task([
  'go build -o bin/example-gw github.com/goguardian/grpc-gateway/examples',
]));
