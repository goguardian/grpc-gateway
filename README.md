...
[![Build Status](https://travis-ci.org/goguardian/grpc-gateway.svg?branch=master)](https://travis-ci.org/goguardian/grpc-gateway)
...
```sh
go get -u github.com/goguardian/grpc-gateway/protoc-gen-grpc-gateway
go get -u github.com/goguardian/grpc-gateway/protoc-gen-swagger
...
3. Generate gRPC stub
   ...
   protoc -I/usr/local/include -I. \
     -I$GOPATH/src \
     -I$GOPATH/src/github.com/goguardian/grpc-gateway/third_party/googleapis \
     --go_out=Mgoogle/api/annotations.proto=github.com/goguardian/grpc-gateway/third_party/googleapis/google/api,plugins=grpc:. \
...
* [How gRPC error codes map to HTTP status codes in the response](https://github.com/goguardian/grpc-gateway/blob/master/runtime/errors.go#L15)
...
# Contribution
See [CONTRIBUTING.md](http://github.com/goguardian/grpc-gateway/blob/master/CONTRIBUTING.md).

# License
grpc-gateway is licensed under the BSD 3-Clause License.
See [LICENSE.txt](https://github.com/goguardian/grpc-gateway/blob/master/LICENSE.txt) for more details.
